 ...
 */
export function createMultisig(connection, payer, signers, m, keypair, confirmOptions, programId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getMinimumBalanceForRentExemptMultisig(connection)];
                case 1:
                    lamports = _a.sent();
