 ...
 */
export function createNativeMint(connection, payer, confirmOptions, programId, nativeMint) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    transaction = new Transaction().add(createCreateNativeMintInstruction(payer.publicKey, programId, nativeMint));
